 ...
 */
class Tx_SbPortfolio2_Domain_Model_ClientTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 ...
	 * @test
	 */
	public function getLinksReturnsInitialValueForTx_SbPortfolio2_Domain_Model_Link() { }
